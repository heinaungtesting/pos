                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col mb-3">
                                ...
                                <input value="{{old('name',$product->name)}}" type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                            ...
                            <div class="col mb-3">
                                ...
                                <select name="categoryid" id=""  class="form-control @error('categoryid') is-invalid @enderror">
                                    ...
                                    @foreach ($category as  $item)
                                      <option value="{{$item->id}}" @if (old('categoryid',$item->category_id)==$item->id)selected
                       ...
                       <div class="row">
                        <div class="col mb-3">
                            ...
                            <input value="{{old('price',$product->price)}}$" type="text" name="price" class="form-control @error('price') is-invalid @enderror"
                        ...
                        <div class="col mb-3">
                            ...
                            <input value="{{old('stock',$product->stock)}}" type="text" name="stock" class="form-control @error('stock') is-invalid @enderror"
                        ...
                        <div class="mb-3">
                            <input type="submit"  class="btn btn-primary w-100 rounded shadow-sm" value="Update Product">
                    </div>
                </form>
