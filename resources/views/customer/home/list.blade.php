                        ...
                        <div class="row">
                            ...
                            <div class="col ">
                                <form action="{{ route('customerhome') }}" method="get">
                                    ...
                                    <input type="submit" value="Sort" class="btn btn-sm btn-success my-2 w-25">
                                </form>
                            </div>
                        </div>
                        <div class=>
                            <form action="{{ route('customerhome') }}" method="get">
                                @csrf
                                <input type="text" class="form-control" name="minprice" value="{{ request('minprice') }}"
                                    id="" placeholder="Minimum price...">
                                <input type="text" class="form-control" name="maxprice" value="{{ request('maxprice') }}"
                                    id="" placeholder="Maximum price...">
                                <input type="submit" value="Search" class="d-inline btn  btn-success float-end">
                            </form>
